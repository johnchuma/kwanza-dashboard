        ...
        <div className="w-11/12 md:w-10/12 mx-auto space-y-3 pt-2 pb-10">
          <div className="space-y-3">
            ...
            <p>
              ...
              website (the "Service") operated by Kwanza Advertising Network
            ...
            <p>
              ...
              that are not owned or controlled by Kwanza Advertising Network.
              Kwanza Advertising Network has no control over, and assumes no
              responsibility for, the content, privacy policies, or practices of
              any third party web sites or services. You further acknowledge and
              agree that Kwanza Advertising Network shall not be responsible or
            ...
            <h2 className="font-semibold text-lg text-dark">Termination</h2>
            <p>
            ...
            <h2 className="font-semibold text-lg text-dark">Governing Law</h2>
            <p>
              These Terms shall be governed and construed in accordance with the
              laws of Tanzania, without regard to its conflict of law
            ...
            <h2 className="font-semibold text-lg text-dark">Changes</h2>
            <p>
            ...
            <h2 className="font-semibold text-lg text-dark">Contact Us</h2>
            <p>
              If there are any questions regarding this privacy policy, you may
              contact us using the information below.
            </p>
            <address className="not-italic">
              <p className="font-bold">Kwanza Advertising Network</p>
              <p>House 45 – Senga Road</p>
